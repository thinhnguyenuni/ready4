...
<!--                   </li> -->
                   ...
                   <li class="nav-item active"><a class="nav-link" href="${pageContext.request.contextPath}/maudat/create">Tạo mẫu đất</a></li>
                   <li class="nav-item active"><a class="nav-link" href="${pageContext.request.contextPath}/giaodich/list">Thông tin giao dịch</a></li>
              </ul>
          </div>
      </div>
  </nav>
